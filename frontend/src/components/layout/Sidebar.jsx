...
import { LayoutGrid, ShoppingCart, Heart, CalendarDays, Search, Settings, Sun, Moon, Monitor, LogOut, Plus, Upload, BookOpen, TrendingUp, Shield, Database, Compass, Library, ChevronRight, Download, FileText, User, Receipt, Sparkles } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const tier2Items = [
    ...
    { to: '/year-in-review', icon: Sparkles, label: 'Year in Cooking' },
